...
import { NailedCoreAgentContribution } from './nailedCoreAgentContribution.js';
...
registerWorkbenchContribution2(NailedCoreAgentContribution.ID, NailedCoreAgentContribution, WorkbenchPhase.BlockStartup);
