...
- 主 Chat View 默认没有传自定义 `submitHandler`，所以一般都会走默认链路；宿主创建 widget 的位置在 `src/vs/workbench/contrib/chat/browser/widgetHosts/viewPane/chatViewPane.ts:519`
...
## 建议的第一刀
- 如果你是想“改 AI 聊天体验”，先看：
  - `src/vs/workbench/contrib/chat/browser/widget/chatWidget.ts:2199`
  - `src/vs/workbench/contrib/chat/common/chatService/chatServiceImpl.ts:799`
- 如果你是想“接自己的模型 / agent 后端”，先看：
  - `src/vs/workbench/contrib/chat/common/participants/chatAgents.ts:507`
  - `src/vs/workbench/api/browser/mainThreadChatAgents2.ts:287`
  - `src/vs/workbench/api/common/extHostChatAgents2.ts:751`
- 如果你是想“增强 coding agent / 工具调用”，先看：
  - `src/vs/workbench/contrib/chat/common/tools/languageModelToolsService.ts:554`
  - `src/vs/workbench/contrib/chat/common/tools/builtinTools/tools.ts:61`
